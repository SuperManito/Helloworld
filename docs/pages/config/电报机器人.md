...
![create_bot](../../src/img/TelegramBot/1.png ':size=600x600')
...
![create_application](../../src/img/TelegramBot/2.png ':size=800x600')

- 下面是创建完的截图，将获取到的 `api_id` 和 `api_hash` 填入 **bot.json** 完成配置

![create_application](../../src/img/TelegramBot/3.png)
